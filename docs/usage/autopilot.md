...
See `examples/ralph/` for complete examples:
...
- ❌ Run on your main development machine
- ❌ Leave running unattended on important systems
- ❌ Skip reading examples/ralph/README.md safety guidelines
...
- **Comprehensive Guide**: `examples/ralph/README.md` - Safety, prompts, patterns, troubleshooting
